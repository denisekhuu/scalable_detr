...
from prob_sliced_local_head_models.training.engine import train_one_epoch, evaluate
from prob_sliced_local_head_models import build_model
import datetime
...
#python prob_sliced_local_head_main.py --hidden_dim 192 --dim_feedforward 1536 --nheads 6 --batch_size 2 --epochs 1 --lr_drop 1 --output_dir ../temp/temp_output --coco_path C:/workspace/ml/data/coco
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_max_norm, heads=heads, method="stochastic_dropout")
        lr_scheduler.step()
        if args.output_dir:
            checkpoint_paths = [output_dir / 'checkpoint.pth']

...
#python sliced_local_head_main.py --hidden_dim 192 --dim_feedforward 1536 --nheads 6 --batch_size 2 --epochs 1 --lr_drop 1 --output_dir ../temp/temp_output --coco_path C:/workspace/ml/data/coco
